<?php 
  ...
  include("db_connection.php"); 
    $sql = "SELECT trg.*,tg.id glue_id,tg.glue_type as tg_glue_type FROM ta_raw_glue trg join ta_glue tg on (tg.id = trg.glue_type) where trg.rg_id = ".$_GET['id'];
                            ...
                            <div class="container">
                                <div class="tab-content">
                                    <div id="home" class="tab-pane fade show in active">
                                        <form class="user" method="post" action="sav_files/sav_edit_raw_glue_stock.php" style="clear: both;">

                                            <input type="hidden" name="rg_id" value="<?php echo $editresult['rg_id']; ?>">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-4 mb-3 mb-sm-0">
                                                            <select type="text" class="form-control" name="glue_type">
                                                                <option value="default" >Glue type</option>
                                                                <?php
                                                                    $sql = "SELECT * FROM ta_glue where status = 1";
                                                                    $result = $conn->query($sql);
                                                                    while($row = $result->fetch_assoc()) {
                                                                ?>
                                                                <option value="<?php echo $row['id']; ?>" <?php if($row['id'] == $editresult['glue_type']) { echo "selected";} ?>><?php echo $row['glue_type']; ?></option>
                                                            <?php } ?>
                                                            </select>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control form-control-user" name="quantity" placeholder="Quantity" value="<?php echo $editresult['quantity']; ?>">
                                                        </div>
                                                        <div class="col-sm-4 mb-3 mb-sm-0">
                                                            <input type="text" class="form-control form-control-user" name="uom" placeholder="UOM (in kgs)" value="<?php echo $editresult['uom']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control form-control-user" name="no_of_boxes" placeholder="No.of Boxes" value="<?php echo $editresult['no_of_boxes']; ?>">
                                                        </div>
