<?php 
  ...
  $sql = "SELECT trw.*,trw.cft raw_wood_cft,trw.cbm raw_wood_cbm,wt.id wood_type_id, wt.wood_type wood_type_name FROM ta_raw_wood trw join ta_wood_type wt on (wt.id = trw.wood_type)";
  $resp = $conn->query($sql);
  ...
  $sandsql = "SELECT tsp.*,tsgt.paper_grid paper_grid_type FROM ta_sand_paper tsp join ta_sanding_grid_types tsgt on (tsgt.id = tsp.sand_paper_type)";
              ...
              <div class="table-responsive">
              	<!-- Board Manufacturing Table starts  -->
                      ...
                      ?>
                        ...
                        <th><?php echo $rows['raw_wood_cft'];?></th>
        								<th><?php echo $rows['raw_wood_cbm'];?></th>
                        <th><?php //echo $rows['raw_wood_cft'];?></th>
                        <th><?php //echo $rows['raw_wood_cbm'];?></th>
                        <th><?php //echo $rows['raw_wood_cft'];?></th>
                        <th><?php //echo $rows['raw_wood_cbm'];?></th>
                  ...
                  <table class="table table-bordered requestTable" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <!-- <th><?php //echo $gluerows['quantity']; ?></th> -->
                        <th><?php echo $gluerows['quantity'];?></th>
                  ...
                  <table class="table table-bordered requestTable" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <th><?php echo $sandrows['quantity']; ?></th>
                        <th><?php //echo $sandrows['uom'];?></th>
