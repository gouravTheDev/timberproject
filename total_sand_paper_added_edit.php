<?php 
  ...
  $sql = "SELECT tsp.*,tsgt.id as grid_id, tsgt.paper_grid FROM ta_sand_paper tsp join ta_sanding_grid_types tsgt on (tsp.sand_paper_type = tsgt.id) where tsp.sp_id = ".$_GET['id'];
    $result = $conn->query($sql);
    $sand_edit = $result->fetch_assoc();
    print_r($sand_edit);
?>
    <!DOCTYPE html>
    <html lang="en">
                            ...
                            <div class="container">
                                ...
                                <div class="tab-content">
                                    <div id="home" class="tab-pane fade show in active">
                                        ...
                                        <form class="user" method="post" action="sav_files/sav_edit_sand_paper_stock.php" style="clear: both;">
                                            <input type="hidden" name="sp_id" value="<?php echo $sand_edit['sp_id']; ?>">
                                            <div class="col-lg-12">
                                                <div class="">

                                                    <div class="form-group row">
                                                        <div class="col-sm-3 mb-3 mb-sm-0">
                                                            <input type="date" class="form-control form-control-user" name="recieved_date" placeholder="Date" value="<?php echo $sand_edit['recieved_date']; ?>">
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control form-control-user" name="name" placeholder="Name" value="<?php echo $sand_edit['name']; ?>">
                                                        </div>
                                                        <div class="col-sm-3 mb-3 mb-sm-0">
                                                            <input type="text" class="form-control form-control-user" name="vehicle_number" placeholder="Vehicle Number" value="<?php echo $sand_edit['vehicle_number']; ?>">
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control form-control-user" name="reference" placeholder="Reference" value="<?php echo $sand_edit['reference']; ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-4 mb-3 mb-sm-0">
                                                            <select type="text" class="form-control" name="sand_paper_type">
                                                                <option value="default" >Sand Paper type</option>
                                                                <?php
                                                                    $sql = "SELECT * FROM ta_sanding_grid_types where status = 1";
                                                                    $result = $conn->query($sql);
                                                                    while($row = $result->fetch_assoc()) {
                                                                ?>
                                                                <option value="<?php echo $row['id']; ?>" <?php if($row['id'] == $sand_edit['sp_id']) { echo "selected"; } ?>><?php echo $row['paper_grid'];?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control form-control-user" name="quantity" placeholder="Quantity" value="<?php echo $sand_edit['quantity']; ?>">
                                                        </div>
                                                        <div class="col-sm-4 mb-3 mb-sm-0">
                                                            <input type="text" class="form-control form-control-user" name="uom" placeholder="UOM (in kgs)" value="<?php echo $sand_edit['uom']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control form-control-user" name="brand" placeholder="Brand" value="<?php echo $sand_edit['brand']; ?>">
                                                        </div>

                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control form-control-user" name="price" placeholder="Price" value="<?php echo $sand_edit['price']; ?>">
                                                        </div>

                                                        <div class="col-sm-4 mb-3 mb-sm-0">
                                                            <input type="text" class="form-control form-control-user" name="gst" placeholder="GST 18%" value="<?php echo $sand_edit['gst']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-sm-4 mb-3 mb-sm-0">
                                                            <input type="text" class="form-control form-control-user" name="transport_charges" placeholder="Transport Charges" value="<?php echo $sand_edit['transport_charges']; ?>">
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control form-control-user" name="other_charges" placeholder="Other Charges" value="<?php echo $sand_edit['other_charges']; ?>">
                                                        </div>
                                                    </div>
