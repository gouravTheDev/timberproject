                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="length" name="length" class="form-control form-control-user" placeholder="2.7m" onkeyup="cbm_calc();">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                  <div class="col-lg-12">
                                    <div class="col-lg-4 col-xs-6" style="float: right;margin-bottom: 15px;text-align: right;">
                                      ...
                                      <div class="small-box bg-green">
                                        <a class="small-box-footer Remove" id="Remove" style="color: #4e73df; cursor: pointer;">Remove More <i class="fas fa-fw fa-plus-circle"></i></a>
                                      </div>
                                    </div>
                                  </div>
                                </div>  
