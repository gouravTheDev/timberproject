                            ...
                            <div class="">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary" style="text-transform: capitalize;">Add New Snading Paper Grid</h6>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-4 col-xs-6" style="float: right;margin-bottom: 15px;text-align: right;">
                                                    ...
                                                    <div class="small-box bg-green">
                                                        <a href="total_paper_grids.php" class="small-box-footer">View Total Sanding Paper Grids <i class="fa fa-arrow-circle-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <form class="user" method="post" action="sav_files/sav_sand_grid.php" style="clear: both;">
                                                ...
                                                <div class="form-group row col-sm-12">
                                                    <div class="" style="float:right">
                                                        <input type="submit" class="btn btn-primary btn-user btn-block" name="add_glue" value="Add Sanding Paper Grid">
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
